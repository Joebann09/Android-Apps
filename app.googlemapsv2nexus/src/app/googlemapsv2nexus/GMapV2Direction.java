...
public class GMapV2Direction {
	...
	public void setUrl(LatLng start, LatLng end, String mode){
		
		url = "http://maps.googleapis.com/maps/api/directions/xml?" 
        		+ "origin=" + start.latitude + "," + start.longitude  
        		+ "&destination=" + end.latitude + "," + end.longitude 
        		+ "&sensor=true&departure_time=1343605500&units=metric&mode=walking";		
	}
	...
	/*	String url = "http://maps.googleapis.com/maps/api/directions/xml?" 
        ...
        try {
            ...
            URL url = new URL("http://maps.googleapis.com/maps/api/directions/xml?" 
            		+ "origin=" + start.latitude + "," + start.longitude  
            		+ "&destination=" + end.latitude + "," + end.longitude 
            		+ "&sensor=false&departure_time=1343605500&units=metric&mode=" + mode);
